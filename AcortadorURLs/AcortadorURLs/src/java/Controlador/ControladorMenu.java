...
public class ControladorMenu extends HttpServlet {
    String perfil="Vista_usuario/Perfil.jsp";
    String inicio="Vista_usuario/Menu.jsp";
    String suscripciones="Vista_usuario/Suscripciones.jsp";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action != null && !action.isEmpty()) {
            if(action.equalsIgnoreCase("Inicio")){
                ...
                acceso = perfil;
            }else if (action.equalsIgnoreCase("suscripciones")){
                acceso = suscripciones;
            }
        }
